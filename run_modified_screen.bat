@echo off
echo Modified Custom Stock Screener with Clear Stage Counts
echo ====================================================
echo.
...
python custom_screen_modified.py --output perfect_setup_modified.csv --max-stocks 1000 --channels --rsi --rsi-period 14 --monthly-rsi-max 25.0 --volume-min 1000000 --market-cap-min 0 --price-min 0 --rs-min 0 --revenue-growth-min 0 --rs-bypass 0
